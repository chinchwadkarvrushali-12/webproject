    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-dark">
            <div class="modal-header">
                <h5 class="modal-title" id="contactModalLabel">Product Inquiry / Request Details</h5>
            ...
            <div class="modal-body text-start">
                <form action="contact-submit.php" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="request" class="form-label">Your Requirement / Request</label>
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <label class="form-check-label" for="privacy_policy">I accept the Privacy Policy</label>
                    </div>
